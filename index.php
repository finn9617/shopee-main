                ...
                <nav class="header__navbar hide-on-mobile-tablet">
                    <ul class="header__nav-list">
                        ...
                        <div class="header__qrcode">
                            <img src="<?php bloginfo('template_directory'); ?>/assets/img/qr/qr-code.png" class="header__qr">
                            <div class="header__apps">
                                <a href="#" class="header__app-link">
                                    <img src="<?php bloginfo('template_directory'); ?>/assets/img/qr/app-store.png" class="header__app-img">
                                </a>
                                <a href="#" class="header__app-link">
                                    <img src="<?php bloginfo('template_directory'); ?>/assets/img/qr/gg-play.png" class="header__app-img">
                                </a>
                                <a href="#" class="header__app-link">
                                    <img src="<?php bloginfo('template_directory'); ?>/assets/img/qr/app-gallery.png" class="header__app-img">
                                </a>
                                <a href="#" class="header__app-link">
                                    <img src="<?php bloginfo('template_directory'); ?>/assets/img/qr/ltp-img.png" class="header__app-img">
                                </a>
                            </div>
                        </div>
                    ...
                    <ul class="header__nav-list">
                                ...
                                <ul class="header__notifi-list">
                                    <li class="header__notifi-item">
                                        <a href="#" class="header__notifi-link">
                                            <img src="<?php bloginfo('template_directory'); ?>/assets/img/sp/casio.png" class="header__notifi-img">
                                    ...
                                    <li class="header__notifi-item">
                                        <a href="#" class="header__notifi-link">
                                            <img src="<?php bloginfo('template_directory'); ?>/assets/img/sp/iphone.png" class="header__notifi-img">
                                            <div class="header__notifi-info">
                                                <div class="header__notifi-name">
                                    ...
                                    <li class="header__notifi-item">
                                        <a href="#" class="header__notifi-link">
                                            <img src="<?php bloginfo('template_directory'); ?>/assets/img/sp/iphone2.png" class="header__notifi-img">
                                            <div class="header__notifi-info">
                                                <div class="header__notifi-name">
                                    ...
                                    <li class="header__notifi-item">
                                        <a href="#" class="header__notifi-link">
                                            <img src="<?php bloginfo('template_directory'); ?>/assets/img/sp/laptop.png" class="header__notifi-img">
                                            <div class="header__notifi-info">
                                                <div class="header__notifi-name">
                                    ...
                                    <li class="header__notifi-item">
                                        <a href="#" class="header__notifi-link">
                                            <img src="<?php bloginfo('template_directory'); ?>/assets/img/sp/laptop2.png" class="header__notifi-img">
                                            <div class="header__notifi-info">
                                                <div class="header__notifi-name">
                        ...
                        <!-- <li class="header__nav-item header__nav-user">
                            <img src="<?php bloginfo('template_directory'); ?>/assets/img/user.png" class="header__nav-user-avt">
                ...
                <div class="header__contain">
                    ...
                    <div class="header__logo">
                        <a href="#" class="header__logo-link">
                            <img src="<?php bloginfo('template_directory'); ?>/assets/img/logo/logo-full-white.png" class="header__logo-img">
                        </a>
                    </div>
                    ...
                    <div class="header__cart header__cart--has-cart">
                        ...
                        <div class="header__cart-list no-cart">
                            <img src="<?php bloginfo('template_directory'); ?>/assets/img/sp/no-cart.png" class="header__no-cart-img">
                        ...
                        <div class="header__cart-list has-cart">
                            ...
                            <ul class="header__cart-list-item">
                                <li class="header__cart-item">
                                    <img src="<?php bloginfo('template_directory'); ?>/assets/img/buy/1.PNG" class="header__cart-item-img">
                                ...
                                <li class="header__cart-item">
                                    <img src="<?php bloginfo('template_directory'); ?>/assets/img/buy/2.PNG" class="header__cart-item-img">
                                    <div class="header__cart-item-info">
                                        <div class="header__cart-item-heading">
                                ...
                                <li class="header__cart-item">
                                    <img src="<?php bloginfo('template_directory'); ?>/assets/img/buy/3.PNG" class="header__cart-item-img">
                                    <div class="header__cart-item-info">
                                        <div class="header__cart-item-heading">
                                ...
                                <li class="header__cart-item">
                                    <img src="<?php bloginfo('template_directory'); ?>/assets/img/buy/4.PNG" class="header__cart-item-img">
                                    <div class="header__cart-item-info">
                                        <div class="header__cart-item-heading">
                                ...
                                <li class="header__cart-item">
                                    <img src="<?php bloginfo('template_directory'); ?>/assets/img/buy/5.PNG" class="header__cart-item-img">
                                    <div class="header__cart-item-info">
                                        <div class="header__cart-item-heading">
                                            <h3 class="header__cart-item-name">Thanh Thanh 2000 1m57 46kg 88-62-89</h3>
                                            <p class="header__cart-item-price">2.000.000đ</p>
                                ...
                                <li class="header__cart-item">
                                    <img src="<?php bloginfo('template_directory'); ?>/assets/img/buy/6.PNG" class="header__cart-item-img">
                                    <div class="header__cart-item-info">
                                        <div class="header__cart-item-heading">
                                            <h3 class="header__cart-item-name">Hồng Ánh 1998 1m62 48kg 89-64-91</h3>
                                            <p class="header__cart-item-price">2.500.000đ</p>
                                ...
                                <li class="header__cart-item">
                                    <img src="<?php bloginfo('template_directory'); ?>/assets/img/buy/7.PNG" class="header__cart-item-img">
                                    <div class="header__cart-item-info">
                                        <div class="header__cart-item-heading">
                                            <h3 class="header__cart-item-name">Quỳnh Như 1999 1m65 49kg 90-62-89</h3>
                                            <p class="header__cart-item-price">2.800.000đ</p>
                                ...
                                <li class="header__cart-item">
                                    <img src="<?php bloginfo('template_directory'); ?>/assets/img/buy/8.PNG" class="header__cart-item-img">
                                    <div class="header__cart-item-info">
                                        <div class="header__cart-item-heading">
                                            <h3 class="header__cart-item-name">Kim Ngân 2001 1m55 45kg 86-60-87</h3>
                                            <p class="header__cart-item-price">3.200.000đ</p>
                            ...
                            <!-- <div id="list-product" class="row sm-gutter">
                                <div class="col l-2-4 m-3 c-6 home-product-item">
                                    <a class="home-product-item-link" href="#">
                                        <div class="home-product-item__img" style="background-image: url(<?php bloginfo('template_directory'); ?>/assets/img/home/1.PNG);"></div>
                                ...
                                <div class="col l-2-4 m-3 c-6 home-product-item">
                                    <a class="home-product-item-link" href="#">
                                        <div class="home-product-item__img" style="background-image: url(<?php bloginfo('template_directory'); ?>/assets/img/home/2.PNG);"></div>
                                        <div class="home-product-item__info">
                                            <h4 class="home-product-item__name">Ổ đĩa flash USB2.0 2TB Hp kim loại chống thấm nước</h4>
                                            <div class="home-product-item__price">
                                ...
                                <div class="col l-2-4 m-3 c-6 home-product-item">
                                    <a class="home-product-item-link" href="#">
                                        <div class="home-product-item__img" style="background-image: url(<?php bloginfo('template_directory'); ?>/assets/img/home/3.PNG);"></div>
                                        <div class="home-product-item__info">
                                            <h4 class="home-product-item__name">Ổ đĩa flash USB2.0 2TB Hp kim loại chống thấm nước</h4>
                                            <div class="home-product-item__price">
                                ...
                                <div class="col l-2-4 m-3 c-6 home-product-item">
                                    <a class="home-product-item-link" href="#">
                                        <div class="home-product-item__img" style="background-image: url(<?php bloginfo('template_directory'); ?>/assets/img/home/4.PNG);"></div>
                                        <div class="home-product-item__info">
                                            <h4 class="home-product-item__name">Ổ đĩa flash USB2.0 2TB Hp kim loại chống thấm nước</h4>
                                            <div class="home-product-item__price">
                                ...
                                <div class="col l-2-4 m-3 c-6 home-product-item">
                                    <a class="home-product-item-link" href="#">
                                        <div class="home-product-item__img" style="background-image: url(<?php bloginfo('template_directory'); ?>/assets/img/home/5.PNG);"></div>
                                        <div class="home-product-item__info">
                                            <h4 class="home-product-item__name">Ổ đĩa flash USB2.0 2TB Hp kim loại chống thấm nước</h4>
                                            <div class="home-product-item__price">
                                ...
                                <div class="col l-2-4 m-3 c-6 home-product-item">
                                    <a class="home-product-item-link" href="#">
                                        <div class="home-product-item__img" style="background-image: url(<?php bloginfo('template_directory'); ?>/assets/img/home/6.PNG);"></div>
                                        <div class="home-product-item__info">
                                            <h4 class="home-product-item__name">Ổ đĩa flash USB2.0 2TB Hp kim loại chống thấm nước</h4>
                                            <div class="home-product-item__price">
                                ...
                                <div class="col l-2-4 m-3 c-6 home-product-item">
                                    <a class="home-product-item-link" href="#">
                                        <div class="home-product-item__img" style="background-image: url(<?php bloginfo('template_directory'); ?>/assets/img/home/7.PNG);"></div>
                                        <div class="home-product-item__info">
                                            <h4 class="home-product-item__name">Ổ đĩa flash USB2.0 2TB Hp kim loại chống thấm nước</h4>
                                            <div class="home-product-item__price">
                                ...
                                <div class="col l-2-4 m-3 c-6 home-product-item">
                                    <a class="home-product-item-link" href="#">
                                        <div class="home-product-item__img" style="background-image: url(<?php bloginfo('template_directory'); ?>/assets/img/home/8.PNG);"></div>
                                        <div class="home-product-item__info">
                                            <h4 class="home-product-item__name">Ổ đĩa flash USB2.0 2TB Hp kim loại chống thấm nước</h4>
                                            <div class="home-product-item__price">
                                ...
                                <div class="col l-2-4 m-3 c-6 home-product-item">
                                    <a class="home-product-item-link" href="#">
                                        <div class="home-product-item__img" style="background-image: url(<?php bloginfo('template_directory'); ?>/assets/img/home/9.PNG);"></div>
                                        <div class="home-product-item__info">
                                            <h4 class="home-product-item__name">Ổ đĩa flash USB2.0 2TB Hp kim loại chống thấm nước</h4>
                                            <div class="home-product-item__price">
                                ...
                                <div class="col l-2-4 m-3 c-6 home-product-item">
                                    <a class="home-product-item-link" href="#">
                                        <div class="home-product-item__img" style="background-image: url(<?php bloginfo('template_directory'); ?>/assets/img/home/10.PNG);"></div>
                                        <div class="home-product-item__info">
                                            <h4 class="home-product-item__name">Ổ đĩa flash USB2.0 2TB Hp kim loại chống thấm nước</h4>
                                            <div class="home-product-item__price">
                                                <p class="home-product-item__price-old">180.000đ</p>
                                ...
                                <div class="col l-2-4 m-3 c-6 home-product-item">
                                    <a class="home-product-item-link" href="#">
                                        <div class="home-product-item__img" style="background-image: url(<?php bloginfo('template_directory'); ?>/assets/img/home/11.PNG);"></div>
                                        <div class="home-product-item__info">
                                            <h4 class="home-product-item__name">Ổ đĩa flash USB2.0 2TB Hp kim loại chống thấm nước</h4>
                                            <div class="home-product-item__price">
                                                <p class="home-product-item__price-old">180.000đ</p>
                                ...
                                <div class="col l-2-4 m-3 c-6 home-product-item">
                                    <a class="home-product-item-link" href="#">
                                        <div class="home-product-item__img" style="background-image: url(<?php bloginfo('template_directory'); ?>/assets/img/home/12.PNG);"></div>
                                        <div class="home-product-item__info">
                                            <h4 class="home-product-item__name">Ổ đĩa flash USB2.0 2TB Hp kim loại chống thấm nước</h4>
                                            <div class="home-product-item__price">
                                                <p class="home-product-item__price-old">180.000đ</p>
                                ...
                                <div class="col l-2-4 m-3 c-6 home-product-item">
                                    <a class="home-product-item-link" href="#">
                                        <div class="home-product-item__img" style="background-image: url(<?php bloginfo('template_directory'); ?>/assets/img/home/13.PNG);"></div>
                                        <div class="home-product-item__info">
                                            <h4 class="home-product-item__name">Ổ đĩa flash USB2.0 2TB Hp kim loại chống thấm nước</h4>
                                            <div class="home-product-item__price">
                                                <p class="home-product-item__price-old">180.000đ</p>
                                ...
                                <div class="col l-2-4 m-3 c-6 home-product-item">
                                    <a class="home-product-item-link" href="#">
                                        <div class="home-product-item__img" style="background-image: url(<?php bloginfo('template_directory'); ?>/assets/img/home/14.PNG);"></div>
                                        <div class="home-product-item__info">
                                            <h4 class="home-product-item__name">Ổ đĩa flash USB2.0 2TB Hp kim loại chống thấm nước</h4>
                                            <div class="home-product-item__price">
                                                <p class="home-product-item__price-old">180.000đ</p>
                                ...
                                <div class="col l-2-4 m-3 c-6 home-product-item">
                                    <a class="home-product-item-link" href="#">
                                        <div class="home-product-item__img" style="background-image: url(<?php bloginfo('template_directory'); ?>/assets/img/home/15.PNG);"></div>
                                        <div class="home-product-item__info">
                                            <h4 class="home-product-item__name">Ổ đĩa flash USB2.0 2TB Hp kim loại chống thấm nước</h4>
                                            <div class="home-product-item__price">
                                                <p class="home-product-item__price-old">180.000đ</p>
                                ...
                                <div class="col l-2-4 m-3 c-6 home-product-item">
                                    <a class="home-product-item-link" href="#">
                                        <div class="home-product-item__img" style="background-image: url(<?php bloginfo('template_directory'); ?>/assets/img/home/16.PNG);"></div>
                                        <div class="home-product-item__info">
                                            <h4 class="home-product-item__name">Ổ đĩa flash USB2.0 2TB Hp kim loại chống thấm nước</h4>
                                            <div class="home-product-item__price">
                                                <p class="home-product-item__price-old">180.000đ</p>
                                ...
                                <div class="col l-2-4 m-3 c-6 home-product-item">
                                    <a class="home-product-item-link" href="#">
                                        <div class="home-product-item__img" style="background-image: url(<?php bloginfo('template_directory'); ?>/assets/img/home/17.PNG);"></div>
                                        <div class="home-product-item__info">
                                ...
                                <div class="col l-2-4 m-3 c-6 home-product-item">
                                    <a class="home-product-item-link" href="#">
                                        <div class="home-product-item__img" style="background-image: url(<?php bloginfo('template_directory'); ?>/assets/img/home/18.PNG);"></div>
                                        <div class="home-product-item__info">
                                ...
                                <div class="col l-2-4 m-3 c-6 home-product-item">
                                    <a class="home-product-item-link" href="#">
                                        <div class="home-product-item__img" style="background-image: url(<?php bloginfo('template_directory'); ?>/assets/img/home/19.PNG);"></div>
                                        <div class="home-product-item__info">
                                ...
                                <div class="col l-2-4 m-3 c-6 home-product-item">
                                    <a class="home-product-item-link" href="#">
                                        <div class="home-product-item__img" style="background-image: url(<?php bloginfo('template_directory'); ?>/assets/img/home/20.PNG);"></div>
                                        <div class="home-product-item__info">
                                ...
                                <div class="col l-2-4 m-3 c-6 home-product-item">
                                    <a class="home-product-item-link" href="#">
                                        <div class="home-product-item__img" style="background-image: url(<?php bloginfo('template_directory'); ?>/assets/img/home/21.PNG);"></div>
                                        <div class="home-product-item__info">
                                ...
                                <div class="col l-2-4 m-3 c-6 home-product-item">
                                    <a class="home-product-item-link" href="#">
                                        <div class="home-product-item__img" style="background-image: url(<?php bloginfo('template_directory'); ?>/assets/img/home/22.PNG);"></div>
                                        <div class="home-product-item__info">
                                ...
                                <div class="col l-2-4 m-3 c-6 home-product-item">
                                    <a class="home-product-item-link" href="#">
                                        <div class="home-product-item__img" style="background-image: url(<?php bloginfo('template_directory'); ?>/assets/img/home/23.PNG);"></div>
                                        <div class="home-product-item__info">
                                ...
                                <div class="col l-2-4 m-3 c-6 home-product-item">
                                    <a class="home-product-item-link" href="#">
                                        <div class="home-product-item__img" style="background-image: url(<?php bloginfo('template_directory'); ?>/assets/img/home/24.PNG);"></div>
                                        <div class="home-product-item__info">
                                ...
                                <div class="col l-2-4 m-3 c-6 home-product-item">
                                    <a class="home-product-item-link" href="#">
                                        <div class="home-product-item__img" style="background-image: url(<?php bloginfo('template_directory'); ?>/assets/img/home/25.PNG);"></div>
                                        <div class="home-product-item__info">
                            ...
                            <div class="col l-2-4 m-4 c-12 pay-and-ship">
                                <div>
                                    ...
                                    <div class="footer-sale-ship">
                                        <img src="<?php bloginfo('template_directory'); ?>/assets/img/pay/1.PNG" class="footer-item-sale-ship">
                                        <img src="<?php bloginfo('template_directory'); ?>/assets/img/pay/2.PNG" class="footer-item-sale-ship">
                                        <img src="<?php bloginfo('template_directory'); ?>/assets/img/pay/3.PNG" class="footer-item-sale-ship">
                                        <img src="<?php bloginfo('template_directory'); ?>/assets/img/pay/4.PNG" class="footer-item-sale-ship">
                                        <img src="<?php bloginfo('template_directory'); ?>/assets/img/pay/5.PNG" class="footer-item-sale-ship">                                
                                    </div>
                                </div>
                                <div>
                                    <h3 class="footer__heading">ĐƠN VỊ VẬN CHUYỂN</h3>
                                    <div class="footer-sale-ship">
                                        <img src="<?php bloginfo('template_directory'); ?>/assets/img/ship/1.PNG" class="footer-item-sale-ship">
                                        <img src="<?php bloginfo('template_directory'); ?>/assets/img/ship/2.PNG" class="footer-item-sale-ship">
                                        <img src="<?php bloginfo('template_directory'); ?>/assets/img/ship/3.PNG" class="footer-item-sale-ship">
                                        <img src="<?php bloginfo('template_directory'); ?>/assets/img/ship/4.PNG" class="footer-item-sale-ship">
                                        <img src="<?php bloginfo('template_directory'); ?>/assets/img/ship/5.PNG" class="footer-item-sale-ship">
                                        <img src="<?php bloginfo('template_directory'); ?>/assets/img/ship/6.PNG" class="footer-item-sale-ship">
                                        <img src="<?php bloginfo('template_directory'); ?>/assets/img/ship/7.PNG" class="footer-item-sale-ship">
                                        <img src="<?php bloginfo('template_directory'); ?>/assets/img/ship/8.PNG" class="footer-item-sale-ship">
                                        <img src="<?php bloginfo('template_directory'); ?>/assets/img/ship/9.PNG" class="footer-item-sale-ship">
                                    </div>
                                </div>
                            </div>
                            <div class="col l-2-4 m-4 c-6">
                            ...
                            <div class="col l-2-4 m-8 c-6">
                                ...
                                <div class="footer-download">
                                    <a href="#" class="footer-download-link">
                                        <img src="<?php bloginfo('template_directory'); ?>/assets/img/qr/qr-code.png" class="footer-download-qr">
                                    </a>
                                    <div class="footer-download-app">
                                        <a href="#" class="footer-download-link">
                                            <img src="<?php bloginfo('template_directory'); ?>/assets/img/qr/gg-play.png" class="footer-download-app-img">
                                        </a>
                                        <a href="#" class="footer-download-link">
                                            <img src="<?php bloginfo('template_directory'); ?>/assets/img/qr/app-store.png" class="footer-download-app-img">
                                        </a>
                                        <a href="#" class="footer-download-link">
                                            <img src="<?php bloginfo('template_directory'); ?>/assets/img/qr/app-gallery.png" class="footer-download-app-img">
                                        </a>
                                        <a href="#" class="footer-download-link">
                                            <img src="<?php bloginfo('template_directory'); ?>/assets/img/qr/ltp-img.png" class="footer-download-app-img">
                                        </a>
                                    </div>
                                </div>
                            </div>
